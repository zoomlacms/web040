            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="input-group text_300">
                        ...
                        <span class="input-group-btn">
                            <input type="button" value="选择" onclick="user.sel('ReferUser', 'user', 'noplat|1')" class="btn btn-info" />
                        </span>
                    </div>
                ...
                <td>
                    ...
                    <div>
                        <div class="input-group text_300">
                            ...
                            <span class="input-group-btn">
                                <input type="button" value="选择" onclick="user.sel('CCUser', 'user', 'noplat|1')" class="btn btn-info" />
                            </span>
                        </div>
