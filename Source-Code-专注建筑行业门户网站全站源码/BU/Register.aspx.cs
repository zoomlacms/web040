...
namespace ZoomLa.WebSite.User
{
    public partial class User_Register : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (function.isAjax())
            {
                ...
                switch (action)
                {
                    ...
                    case "GetModelFied":
                        ...
                        break;
					case "UserMobileIsExist":
                        result = CheckUserMobileData(value);
            ...
            {
                //DebugUser();
                if (SiteConfig.UserConfig.Agreement.Equals("4")) { Response.Redirect("/User/RegPlat"); return; }
                //根据IP,分析出地址,并填充
                ...
                TxtEmail.Text= function.GetRandomString(10) + "@jt314.com";
        ...
        {
            //if (!mobileBll.CheckVaildCode(TxtMobile.Text, RMobileCode_T.Text)) { function.WriteErrMsg("短信验证码不正确!"); }
                ...
                switch (info.Status)
                {
                    case 0:
                        ...
                        else
                        {
                            ...
                            {
                                RegMessage = RegMessage + "<a href=\"/\">返回首页</a>&nbsp;&nbsp;<a href=\"/User/\">进入会员中心</a>,5秒后系统自动跳转到会员中心!";
                                hfReturnUrl.Value = "/User/";
                            }
                            else
                            {
            ...
            {
                RegMessage = "注册失败！";
                RegMessage = RegMessage + "<a href=\"/\">返回首页</a>&nbsp;&nbsp;<a href=\"/User/Register\">重新注册</a>";
            }
        ...
        private void InitProtocol()
        {
            try
            {
                LitProtocol.Text = FileSystemObject.ReadFile(base.Request.MapPath("/BU/Protocol.txt"));
                Agreement_Lit.Text = SafeSC.ReadFileStr(base.Request.MapPath("/BU/Protocol.txt"),true);
            }
        ...
        public string CheckUserMobileData(string mobile)
        {
            string str = "";
        ...
        public string CheckUserData(string eventArgument)
        {
            ...
            else
            {
                if (SiteConfig.SiteOption.ServerType == "Server")
                {
                    ...
                    {
                        int unamelength = Encoding.Default.GetByteCount(eventArgument);
                        if (SiteConfig.UserConfig.UserNameLimit > unamelength || unamelength > SiteConfig.UserConfig.UserNameMax)
                        {
                            result = "error";
                        }
                        else
