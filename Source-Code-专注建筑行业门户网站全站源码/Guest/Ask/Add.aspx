<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="ZoomLaCMS.Guest.Ask.Add" MasterPageFile="~/Guest/Ask/Ask.master"  ValidateRequest="false"%>
    ...
    <div class="container">
        ...
        <div role="form">
            ...
            <div class="form-group">
                ...
                <label>
                    <asp:CheckBox ID="isNi" runat="server" />
                    匿名</label>
                <div id="needlog_div" runat="server" visible="false" class="alert alert-danger" role="alert">提示:当前系统不支持游客身份提问,请<a href="/User/Login?ReturnUrl=/Guest/Ask/Add.aspx">登录</a></div>
            ...
            <div id="fix" class="form-group" runat="server" visible="false">
                ...
                <a href="javascript:void(0)" onclick="removeFix()">
                    <img src="/App_Themes/Guest/images/layer_close.png" style="width: 14px; height: 13px;" alt="" /></a>
            </div>
