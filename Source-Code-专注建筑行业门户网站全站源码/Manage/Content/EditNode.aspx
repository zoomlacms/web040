<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNode.aspx.cs" Inherits="ZoomLaCMS.Manage.Content.EditNode" MasterPageFile="~/Manage/I/Default.master"%>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content">
        ...
        <div class="panel-footer text-center" style="border-bottom:1px solid #ddd;">
            ...
            <asp:Button ID="Cancel_B" CssClass="btn btn-primary" Text="取消" OnClick="Cancel_B_Click" runat="server" />
        </div>
    </div>
