...
{
    public partial class ZoneManage :CustomerPageAction
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!B_ARoleAuth.Check(ZLEnum.Auth.other, "ZoneManage"))
            {
            ...
            Call.SetBreadCrumb(Master, "<li><a href='" + CustomerPageAction.customPath2 + "Main.aspx'>工作台</a></li><li><a href='" + customPath2 + "User/UserManage.aspx'>会员管理</a></li><li><a href='ZoneManage.aspx'>会员空间管理</a></li><li class='active'>会员空间管理</li>" + Call.GetHelp(108));
        }
        private void GetInit()
        {
            ...
            //this.Label1.Text = cc.PageSize.ToString();
