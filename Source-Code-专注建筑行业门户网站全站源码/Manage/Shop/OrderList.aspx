<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderList.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.OrderList" MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="top_opbar">
        <div class="input-group pull-left" style="width:280px;">
            ...
            <asp:DropDownList ID="QuickSearch_DP" style="width:180px;" CssClass="form-control text_md" runat="server" AutoPostBack="True" OnSelectedIndexChanged="QuickSearch_DP_SelectedIndexChanged">
        ...
        <div class="input-group pull-left" style="width:346px;margin-right:15px;">
            <span class="input-group-addon">开始</span>
            <asp:TextBox ID="SDate_T" runat="server" CssClass="form-control" Width="120" placeholder="开始时间" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'EDate_T\')}'});" />
            <span class="input-group-addon">结束</span>
            <asp:TextBox ID="EDate_T" runat="server" CssClass="form-control" Width="120" placeholder="结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'SDate_T\')}'});" />
        </div>
        <div class="input-group pull-left" style="width:440px;">
            <span class="input-group-addon">高级查询</span>
            <asp:DropDownList ID="SkeyType_DP" CssClass="form-control" runat="server" style="border-right:none;width:120px;">
                <asp:ListItem Selected="True" Value="1" Text="订单编号"></asp:ListItem>
                <asp:ListItem Value="2" Text="客户名称"></asp:ListItem>
                <asp:ListItem Value="3" Text="会员名"></asp:ListItem>
                <asp:ListItem Value="14" Text="会员ID"></asp:ListItem>
                <asp:ListItem Value="15" Text="真实会员姓名"></asp:ListItem>
                <asp:ListItem Value="4" Text="收货人"></asp:ListItem>
                <asp:ListItem Value="5" Text="联系地址"></asp:ListItem>
                <asp:ListItem Value="6" Text="联系电话"></asp:ListItem>
                <asp:ListItem Value="8" Text="备注留言"></asp:ListItem>
                <asp:ListItem Value="9" Text="商品名称"></asp:ListItem>
                <asp:ListItem Value="10" Text="收货人邮箱"></asp:ListItem>
                <asp:ListItem Value="11" Text="发票信息"></asp:ListItem>
                <asp:ListItem Value="12" Text="内部记录"></asp:ListItem>
                <asp:ListItem Value="13" Text="跟单员"></asp:ListItem>
            </asp:DropDownList>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function OutToExcel() {
            var $html = $(document.getElementById("tb_div").outerHTML);
