<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Interactive.aspx.cs" Inherits="ZoomLaCMS.Guest.Ask.Interactive" MasterPageFile="~/Guest/Ask/Ask.master" ValidateRequest="false" %>
...
<span  style="<%=getstyle()%>"> 您好！<a href="/user/" target="_blank"><asp:Label runat="server"  ID="user"></asp:Label></a> 欢迎来<%Call.Label("{$SiteName/}"); %>问答系统！ [<a href="<%=ResolveUrl("~/User/User/Logout") %>?url=/Guest/Default.aspx">退出登录</a>]</span> 
<span  style="<%=getstyles()%>">[<a  href="/user/Login?ReturnUrl=/guest/">请登录</a>] [<a  href="/user/register?ReturnUrl=/guest/">免费注册</a>]</span>
</div>
<div class="hidden">
<div class="h_top">
<div class="logo">
...
<script type="text/javascript">
    ...
    function LikeQue(){
        ...
        //location.href="/User/Content/AddToFav?Url=<%=Request.RawUrl %>&itemid=<%=Request["ID"] %>&type=4&title="+$("#question").text();
    }
</script>
</asp:Content>
