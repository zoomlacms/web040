<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestShow.aspx.cs" Inherits="ZoomLaCMS.Guest.GuestShow" MasterPageFile="~/Common/Master/Empty.master"  ValidateRequest="false"%>
    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                ...
                <li role="presentation"><a role="menuitem" tabindex="-1" href="/User/User/Logout">安全退出</a></li>
            </ul>
                            </div>
                        </li>
...
<div class="container">
    ...
    <div class="s_body">
        ...
        <div id="g_send" class="rg_inout">
            <div id="banAnony" class="alert alert-danger" role="alert" runat="server" visible="false">你好请先登录，再发布留言!<a href="/user/Login?ReturnUrl=/guest/" style="color: #133db6;">[点击登录]</a></div>
