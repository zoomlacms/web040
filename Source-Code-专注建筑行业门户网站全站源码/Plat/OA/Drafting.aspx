<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Drafting.aspx.cs" Inherits="ZoomLaCMS.Plat.OA.Drafting"  MasterPageFile="~/Plat/Main.master" ValidateRequest="false"  %>
...
<table class="table table-bordered" style="margin-top:10px;">
  ...
  <tr>
	...
	<td colspan="1" style="width: 300px;"><asp:TextBox ID="Title_T" runat="server" Width="200" CssClass="form-control" />
