<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="ZoomLaCMS.Cart.cart"  MasterPageFile="~/Cart/order.master" %>
...
<script>
    ...
    function ChangePronum(obj, action) {
        var id = $(obj).closest(".cart_item").data("id");
        var text = $(obj).closest(".cart_item").find(".pronum_text")[0];
    ...
    function ChkByStore(obj) {
        $(obj).closest(".cart_body").find(":checkbox[name=prochk]").each(function () {
