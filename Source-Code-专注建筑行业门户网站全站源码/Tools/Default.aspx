...
<ul>
	<li><asp:TextBox ID="UserName_T" placeholder="管理员" runat="server" CssClass="form-control text_300" data-enter="0"/></li>
	<li><asp:TextBox TextMode="Password" ID="UserPwd_T" placeholder="口令" runat="server" CssClass="form-control text_300" data-enter="1"/></li>
	<li>
	...
	<li><asp:Button ID="Login_Btn" runat="server" CssClass="btn btn-primary text_300" OnClick="Login_Btn_Click" Text="登录" data-enter="3"/></li>
</ul>
</div>
...
<ul class="nav nav-tabs">
    ...
    <li><a href="#tab1" data-toggle="tab">功能处理</a></li>
</ul>
    ...
    <div class="tab-pane active" id="tab0">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr><td>文本加密/解密:
                ...
                <asp:TextBox runat="server" ID="Before_T" TextMode="MultiLine" CssClass="form-control m715-50" style="height:80px;" placeholder="需要处理的字符串" />
                <asp:TextBox runat="server" ID="After_T" TextMode="MultiLine"  CssClass="form-control m715-50 margin_t5" style="height:80px;" placeholder="字符串加密/解密结果"/>
                </td></tr>
        </table>
    </div>
