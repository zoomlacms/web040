...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        <table class="table table-striped table-bordered table-hover" >
        <tr>
            <td class="td_s"></td><td class="td_s">ID</td><td class="text_300"><asp:Label ID="Label1" runat="server"></asp:Label></td><td>操作</td>
        </tr>
        <ZL:ExRepeater ID="ExRepeater1" runat="server" OnItemCommand="RPT_ItemCommand" PageSize="20" PagePre="<tr><td><input type='checkbox' id='chkAll'/></td><td colspan='6'><div class='text-center'>" PageEnd="</div></td></tr>">
            <ItemTemplate>
                <tr>
                    <td><input type="checkbox" value="<%#Eval("GradeID") %>" data-name="<%#Eval("GradeName") %>" name="idchk" /></td>
                    <td><%#Eval("GradeID") %></td>
    ...
    <div id="EditGrade_div" style="display:none;">
        <div class="text-center">
            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control text_300"></asp:TextBox>
            <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="确定" OnClick="Save_Btn_Click" />
