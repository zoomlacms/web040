...
<%--<li><a href="#">日程安排</a></li>--%>
<li><a href="javascript:;" onclick="ShowMain('','/Office/Mail/MailManage.aspx?url=Message.aspx');">邮箱</a></li>
		...
		<tr>
			<td id="toolbar1" style="width: 260px;" valign="top">
				<div class="oamain_left">
                    <iframe id="main_left" style="z-index: 2; visibility: inherit; width: 100%;height:700px;" name="main_right" src="/Office/Menu/LeftMenu.aspx?leftul=userinfo_ul" frameborder="0"></iframe>			
			...
			<td valign="top">
				<iframe id="main_right" style="z-index: 2; visibility: inherit; width: 100%;" name="main_right" src="/Office/Main.aspx" frameborder="0"></iframe>
			</td>
		</tr>
	</table>
