<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Design.aspx.cs" Inherits="ZoomLaCMS.App.APPTip.Design" MasterPageFile="~/Common/Master/Empty.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        ...
        <div>
            ...
            <ul class="list-inline pull-right">
                <li><a href="http://app.z01.com/" target="_blank"><i class="fa fa-book"></i> 线上版本</a></li>
                <li><a href="/User/"><i class="fa fa-user"></i> 会员中心</a></li>
                <li><a href="/User/User/Logout"><i class="fa fa-power-off"></i> 退出</a></li>
                </ul>
            </div>
